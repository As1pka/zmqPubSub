...
QT_MOC_LITERAL(3, 15, 7), // "failure"
QT_MOC_LITERAL(4, 23, 4), // "what"
QT_MOC_LITERAL(5, 28, 5), // "start"
QT_MOC_LITERAL(6, 34, 4) // "stop"

    },
    "Base\0finished\0\0failure\0what\0start\0"
    "stop"
};
...
void Base::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Base::finished)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Base::failure)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Base::failure(const QString & _t1)
{
